...
class TopologiqToTQECTranslator(base_translation_layer.BaseTranslationLayer):
    """
    aa
    """
    ...
    def translate(self, topologiq_layer):
        """
        ...
        circuit_name = topologiq_layer.metadata["NAME"] if "NAME" in topologiq_layer.metadata.keys() else "FT_circuit_placeholder_name"
