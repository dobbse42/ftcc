...
class TQECLayer(BaseLayer):
    ...
    def graphs_for_given_basis(self, pre_filled_block_graphs, observable_basis: Basis) -> BlockGraph | None:
    ...
    def compile(self, observable_basis):
        ...
        block_graph_for_computation = self.graphs_for_given_basis(self.filled_block_graph, observable_basis)
